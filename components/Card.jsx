...
export default function Card({ item, media_type }) {
    ...
    return (
        <Container>
            ...
            <div className=" transition w-full h-full  duration-400 group transform ease-in-out hover:scale-110 ml-1 mr-1 mb-3 mt-3 ">
                ...
                <img  onError={e => handleImgError(e)}  loading='lazy' placeholder="empty" className="rounded-md w-full h-full" src={isImgNotFound ? "/img/posterNotFound.png" : `https://image.tmdb.org/t/p/w500${item.poster_path}`} />
            </div>
            </a>
        </Container>
