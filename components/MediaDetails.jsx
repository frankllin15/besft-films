...
const ImgBg = styled.div`
  ...
  background: linear-gradient(
      0deg,
      #130b1a 0,
      rgba(19, 11, 26, 0.84) 25%,
      rgba(19, 11, 26, 0.66) 38%,
      rgba(7, 6, 10, 0.61) 58%,
      rgba(11, 7, 21, 0.76) 100%
    ),
    url(${(props) => props.bgImage}) no-repeat center top;
  /* opacity: .6; */
    ...
    <div className="flex  mt-6  flex-col">
      ...
      <main className="grid grid-cols-300px-1 mb-4  2md:grid-rows-300-1 2md:justify-items-center 2md:grid-cols-1">
        ...
        <section className="flex flex-col ml-6 2md:ml-0 pt-4  max-w-3xl min-h-360 justify-start items-start cursor-default">
          <h1 className="text-4xl mobile:text-xl ml-2 mr-2 mb-4 sm:text-4xl font-semibold  text-white">
