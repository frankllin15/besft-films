        ...
        <div className="flex  mt-6  flex-col">
            ...
            <div className="flex flex-row  md:flex-col p-5 self-start ">
                ...
                <article className="pl-5 mt-4">
                    ...
                    <p id="bio" className="max-h-20  overflow-hidden" onLoad={e => console.log("Event: " + e)} >{data.biography}</p>
                    <span className="cursor-pointer mt-4 text-white" onClick={hendleOverFlow} id="toggleOverflow">Mstrar mais</span>
                </article>
            </div>
