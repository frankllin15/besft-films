import { Media, FullMedia, Peaple } from '../models'
    ...
    Query: {
        ...
        media: async (_, { id, media_type }) => {
            try {
                ...
                return new FullMedia(data, cast)
        ...
        trendingMedia: async (_, { media_type }) => {
            ...
            try {
                ...
                return await json.map(e => new Media(e))
        ...
        mediaByGenre: async (_, { media_type, genre_id, page, period }) => {
            ...
            try {
                ...
                const results = (await json.results).map(e => new Media(e))
